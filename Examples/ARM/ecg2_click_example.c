...
// ADS1194 pins
sbit ECG2_DRDY  at GPIO_PORTH_DATA0_bit;     // DRDY# pin, active low when conversion data is ready
sbit ECG2_CS    at GPIO_PORTG_DATA0_bit;
sbit ECG2_PWDN  at GPIO_PORTC_DATA4_bit;     // PWDN is power down pin, when low ECG chip is in power down mode, this pin must be high for exit power down mode
sbit ECG2_RESET at GPIO_PORTE_DATA2_bit;     // pull RESET pin low to reset ECG chip
sbit ECG2_PACE  at GPIO_PORTD_DATA5_bit;     // analog input for pulse detect
