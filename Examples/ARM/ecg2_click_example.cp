#line 1 "C:/Users/Viktor/Desktop/Klikovi/ECG2_click/Release/ARM/ecg2_click_example.c"
#line 1 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
...
#line 35 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
typedef enum
{
 ID_REG = 0,
 CONFIG1_REG,
...
#line 88 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
void ecg2_hal_cs( uint8_t logic );
#line 95 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
void ecg2_hal_rst( uint8_t logic );
#line 102 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
void ecg2_hal_init ( void );
#line 116 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
void ecg2_hal_write
(
 uint8_t* buffer,
 uint16_t count
);
#line 134 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
void ecg2_hal_read
(
 uint8_t* buffer,
 uint16_t count
);
#line 153 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hal.h"
...
#line 1 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
typedef enum
{
 KSPS_8 = 0,
 KSPS_4,
...
#line 95 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
uint8_t ecg2_get_device_id();
#line 104 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_daisy_chain_enable( _Bool  enable);
#line 113 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_oscillator_clock_enable (  _Bool  enable );
#line 122 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_set_output_data_rate(output_data_rate_t output_data_rate);
#line 132 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_set_test_source(test_source_t test_source);
#line 142 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_set_test_amplitude (test_amplitude_t amplitutde);
#line 152 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_set_test_frequency (test_frequency_t frequency);
#line 161 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_power_down_reference_buffer_enable( _Bool  enable);
#line 171 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_set_reference_voltage(reference_voltage_t refvol);
#line 179 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_rld_measurement_enable(  _Bool  enable );
#line 189 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_rldref_source_select(rldef_signal_t source);
#line 197 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_rld_buffer_enable( _Bool  enable);
#line 205 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_rld_sense_enable( _Bool  enable);
#line 213 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
uint8_t ecg2_rld_get_status ();
#line 223 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_lead_off_comparator_threshold_set(lead_off_threshold_t threshold);
#line 231 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_vlead_off_enable( _Bool  enable);
#line 241 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_ilead_off_magnitude_set (ilead_off_magnitude_t set);
#line 251 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_flead_off_frequency_set (uint8_t set);
#line 267 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_configure_channel (uint8_t channel,  _Bool  power_down, uint8_t pga_gain, uint8_t channel_input);
#line 276 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_right_leg_positive_drive_set(uint8_t set);
#line 285 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_right_leg_negative_drive_set(uint8_t set);
#line 294 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_lead_off_positive_channel_select (uint8_t set);
#line 303 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_lead_off_negative_channel_select (uint8_t set);
#line 312 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_lead_off_current_direction_select (uint8_t set);
#line 323 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_pace_detect_even_channels_select (pace_even_channels_t select);
#line 334 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
int8_t ecg2_pace_detect_odd_channels_select (pace_odd_channels_t select);
#line 342 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_pace_detect_buffer_enable (  _Bool  enable );
#line 350 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_single_shot_conversion_enable (  _Bool  enable );
#line 358 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_wct_to_rld_connection_enable (  _Bool  enable );
#line 366 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_lead_off_comparator_enable ( _Bool  enable );
#line 374 "c:/users/viktor/desktop/klikovi/ecg2_click/release/arm/ecg2_hw.h"
void ecg2_wilson_center_terminal_configure (uint16_t set);
#line 5 "C:/Users/Viktor/Desktop/Klikovi/ECG2_click/Release/ARM/ecg2_click_example.c"
...
sbit ECG2_DRDY at GPIO_PORTH_DATA0_bit;
sbit ECG2_CS at GPIO_PORTG_DATA0_bit;
sbit ECG2_PWDN at GPIO_PORTC_DATA4_bit;
sbit ECG2_RESET at GPIO_PORTE_DATA2_bit;
sbit ECG2_PACE at GPIO_PORTD_DATA5_bit;
...
#line 44 "C:/Users/Viktor/Desktop/Klikovi/ECG2_click/Release/ARM/ecg2_click_example.c"
...
void main() {
 ...
 GPIO_Digital_Input(&GPIO_PORTH, _GPIO_PINMASK_0);
 GPIO_Digital_Output(&GPIO_PORTC, _GPIO_PINMASK_4);
 ECG2_PWDN = 1;
 GPIO_Digital_Output(&GPIO_PORTG, _GPIO_PINMASK_0);
 ECG2_CS = 1;
 GPIO_Digital_Output(&GPIO_PORTE, _GPIO_PINMASK_2);
 ECG2_RESET = 1;
